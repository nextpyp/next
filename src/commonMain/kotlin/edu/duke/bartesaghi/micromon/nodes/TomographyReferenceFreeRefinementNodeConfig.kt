...
object TomographyReferenceFreeRefinementNodeConfig : NodeConfig {

	const val ID = "tomo-initial-reconstruct"

	override val id = ID
	override val configId = "tomo_initial_reconstruct"
	override val name = "Calculate reconstruction"
