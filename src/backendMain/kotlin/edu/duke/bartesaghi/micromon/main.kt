...
fun Application.main(config: Config.Web) {
	...
	routing {
		...
		applyRoutes(TomographyInitialRefinementServiceManager)
		applyRoutes(TomographyReferenceFreeRefinementServiceManager)
		applyRoutes(TomographyReferenceBasedRefinementServiceManager)
		applyRoutes(TomographyNewCoarseRefinementServiceManager)
		applyRoutes(TomographyNewCoarseClassificationServiceManager)
		...
		applyRoutes(TomographyAfterFlexibleRefinementServiceManager)
