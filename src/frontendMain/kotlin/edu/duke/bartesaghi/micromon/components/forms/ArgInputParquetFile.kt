	...
	companion object {
		...
		fun initialFolder(outNodes: List<Node>): String? =
			when (val node = outNodes.firstOrNull()) {
				...
				is TomographyMiloEvalNode,
				is TomographyParticlesTrainNode,
				...
				is TomographyFlexibleRefinementNode -> PathType.Project.make("${node.dir}")
