...
object Storage {
	...
	var singleParticleDrgnTabIndex by IntStorageItem("singleParticleDrgnTabIndex")
	...
	var tomographyDrgnEvalVolsTabIndex by IntStorageItem("tomographyDrgnEvalVolsTabIndex")
	...
	var tomographyDrgnTrainPlot4Size by IntStorageItem("tomographyDrgnTrainPlot4Size")
	...
	var tomographyDrgnEvalPlotUmapScatterSubplotkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalPlotUmapScatterSubplotkmeanslabelSize")
	var tomographyDrgnEvalPlotUmapScatterColorkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalPlotUmapScatterColorkmeanslabelSize")
	var tomographyDrgnEvalPlotUmapScatterAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalPlotUmapScatterAnnotatekmeansSize")
	var tomographyDrgnEvalPlotUmapHexbinAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalPlotUmapHexbinAnnotatekmeansSize")
	var tomographyDrgnEvalPlotPcaScatterSubplotkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalPlotPcaScatterSubplotkmeanslabelSize")
	var tomographyDrgnEvalPlotPcaScatterClorkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalPlotPcaScatterClorkmeanslabelSize")
	var tomographyDrgnEvalPlotPcaScatterColorkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalPlotPcaScatterColorkmeanslabelSize")
	var tomographyDrgnEvalPlotPcaScatterAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalPlotPcaScatterAnnotatekmeansSize")
	var tomographyDrgnEvalPlotPcaHexbinAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalPlotPcaHexbinAnnotatekmeansSize")
	var tomographyDrgnEvalPlotTomogramLabelDistributionSize by ImageSizeStorageItem("tomographyDrgnEvalPlotTomogramLabelDistributionSize")
	var tomographyDrgnEvalPlotUmapHexbinAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalPlotUmapHexbinAnnotatepcaSize")
	var tomographyDrgnEvalPlotUmapScatterAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalPlotUmapScatterAnnotatepcaSize")
	var tomographyDrgnEvalPlotPcaHexbinAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalPlotPcaHexbinAnnotatepcaSize")
	var tomographyDrgnEvalPlotPcaScatterAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalPlotPcaScatterAnnotatepcaSize")
	var tomographyDrgnEvalPlotUmapColorlatentpcaSize by ImageSizeStorageItem("tomographyDrgnEvalPlotUmapColorlatentpcaSize")
	var tomographyDrgnEvalClassSize by ImageSizeStorageItem("tomographyDrgnEvalClassSize")
	var tomographyDrgnEvalVolsPlotUmapScatterSubplotkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalPlotVolsUmapScatterSubplotkmeanslabelSize")
	var tomographyDrgnEvalVolsPlotUmapScatterColorkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotUmapScatterColorkmeanslabelSize")
	var tomographyDrgnEvalVolsPlotUmapScatterAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotUmapScatterAnnotatekmeansSize")
	var tomographyDrgnEvalVolsPlotUmapHexbinAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotUmapHexbinAnnotatekmeansSize")
	var tomographyDrgnEvalVolsPlotPcaScatterSubplotkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotPcaScatterSubplotkmeanslabelSize")
	var tomographyDrgnEvalVolsPlotPcaScatterClorkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotPcaScatterClorkmeanslabelSize")
	var tomographyDrgnEvalVolsPlotPcaScatterColorkmeanslabelSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotPcaScatterColorkmeanslabelSize")
	var tomographyDrgnEvalVolsPlotPcaScatterAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotPcaScatterAnnotatekmeansSize")
	var tomographyDrgnEvalVolsPlotPcaHexbinAnnotatekmeansSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotPcaHexbinAnnotatekmeansSize")
	var tomographyDrgnEvalVolsPlotTomogramLabelDistributionSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotTomogramLabelDistributionSize")
	var tomographyDrgnEvalVolsPlotUmapHexbinAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotUmapHexbinAnnotatepcaSize")
	var tomographyDrgnEvalVolsPlotUmapScatterAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotUmapScatterAnnotatepcaSize")
	var tomographyDrgnEvalVolsPlotPcaHexbinAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotPcaHexbinAnnotatepcaSize")
	var tomographyDrgnEvalVolsPlotPcaScatterAnnotatepcaSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotPcaScatterAnnotatepcaSize")
	var tomographyDrgnEvalVolsPlotUmapColorlatentpcaSize by ImageSizeStorageItem("tomographyDrgnEvalVolsPlotUmapColorlatentpcaSize")
	var tomographyDrgnEvalVolsClassSize by ImageSizeStorageItem("tomographyDrgnEvalVolsClassSize")
	var singleParticleDrgnPlotUmapScatterSubplotkmeanslabelSize by ImageSizeStorageItem("singleParticleDrgnPlotUmapScatterSubplotkmeanslabelSize")
	var singleParticleDrgnPlotUmapHexbinSize by ImageSizeStorageItem("singleParticleDrgnPlotUmapHexbinSize")
	var singleParticleDrgnPlotUmapMarginalsSize by ImageSizeStorageItem("singleParticleDrgnPlotUmapMarginalsSize")
	var singleParticleDrgnPlotUmapSize by ImageSizeStorageItem("singleParticleDrgnPlotUmapSize")
	var singleParticleDrgnPlotPcaHexbinSize by ImageSizeStorageItem("singleParticleDrgnPlotPcaHexbinSize")
	var singleParticleDrgnPlotPcaMarginalsSize by ImageSizeStorageItem("singleParticleDrgnPlotPcaMarginalsSize")
	var singleParticleDrgnPlotPcaSize by ImageSizeStorageItem("singleParticleDrgnPlotPcaSize")
	var singleParticleDrgnPlotUmapTraversalSize by ImageSizeStorageItem("singleParticleDrgnPlotUmapTraversalSize")
	var singleParticleDrgnPlotUmapTraversalConnectedSize by ImageSizeStorageItem("singleParticleDrgnPlotUmapTraversalConnectedSize")
	var singleParticleDrgnPlotPcaTraversalSize by ImageSizeStorageItem("singleParticleDrgnPlotPcaTraversalSize")
	var singleParticleDrgnPlotPcaHexbinTraversalSize by ImageSizeStorageItem("singleParticleDrgnPlotPcaHexbinTraversalSize")
	var singleParticleDrgnPlotUmapColorlatentpcaSize by ImageSizeStorageItem("singleParticleDrgnPlotUmapColorlatentpcaSize")
	var singleParticleDrgnClassSize by ImageSizeStorageItem("singleParticleDrgnClassSize")
}
