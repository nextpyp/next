...
pub fn sample_ctf(x: f64, y: f64, z: f64, pixel_size: f64, binning_factor: f64) -> Ctf {
	Ctf {
...
pub fn interpolate_tilt_angle(magnitude: u32, tilt_i: u32, num_tilts: u32) -> u32 {
	tilt_i*magnitude*2/(num_tilts - 1) - magnitude
}


pub fn sample_particle_3d(width: u32, height: u32, depth: u32, radius: f64) -> Particle3D {
	Particle3D {
		x: fastrand::u32(0 ..= width) as f64,
		y: fastrand::u32(0 ..= height) as f64,
		z: fastrand::u32(0 ..= depth) as f64,
		r: radius
	}
}

pub fn sample_virion(width: u32, height: u32, depth: u32, radius: f64) -> Virion3D {
	Virion3D {
